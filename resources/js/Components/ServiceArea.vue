                ...
                <div class="row align-items-start">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="title text-center">
                            <span class="text-white text-uppercase d-block mb-6"
                                >Service</span
                            >
                    ...
                    >
                        ...
                        >
                            <div class="row">
                                ...
                                >
                                    ...
                                    >
                                        <img
                                            ...
                                            src="images/icon/ser-icon1.webp"
                                ...
                                >
                                    <div
                                        class="service-text d-inline-block ml-xl-2"
                                    >
                                        <h3 class="mb-15">Web Development</h3>
                                        <p class="mb-0">
                                            In web development, I offer tailored
                                            solutions utilizing HTML, CSS,
                                            JavaScript,PHP and frameworks like
                                            Vue.js, Laravel & Codigniter. From
                                            sleek websites to interactive
                                            applications, I prioritize user
                                            experience and innovation, ensuring
                                            your project stands out and succeeds
                                            online.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                >
                                    ...
                                    >
                                        <img
                                            class="position-relative z-index1"
                                            src="images/icon/ser-icon2.webp"
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <p class="mb-0">
                                            In Flutter app development, I offer
                                            sleek and functional cross-platform
                                            mobile solutions for both Android
                                            and iOS. With a focus on performance
                                            and user experience, I ensure your
                                            app stands out and succeeds in the
                                            competitive market.
                                        </p>
                                    </div>
                                </div>
