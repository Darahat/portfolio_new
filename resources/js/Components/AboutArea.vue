                                ...
                                <div class="about-img-over pl-50 transition5 d-inline-block position-relative">
                                    <div class="position-relative z-index11" data-tilt data-tilt-max="10">
                                        <img class="border-radius10 position-relative z-index11"
                                                    ...
                                                    alt="PHP, laravel, Vue.js Web developer, front-end developer, backend-developer, tailwind CSS">
                                    </div>
                    ...
                    <div class="col-xl-6 col-lg-6  col-md-12 col-sm-12 col-12">
                        <div class="about-content position-relative mb-50">
                            <div class="position-relative">
                                <div class="title">
                                    <span class="meta-text-color text-uppercase d-block mb-1 mt--5">About
                                        Me</span>
                                    <h2 class="mb-30">Hi, I’m Rahat. Nice to meet you.
                                    </h2>
                                </div><!-- /title -->
                            </div>
                            <p class="mb-25">Born in 1993 in Mymensingh, Bangladesh. I believe web Development
                                can be more
                                diverse and
                                inspiring. With a mission to present the possibilities of web Development, I am
                                pursuing new expressions
                                    ...
                                    <div class="col-xl-6  col-lg-12  col-md-6  col-sm-12 col-12">
                                        <ul class="about-info">
                                            ...
                                            <li class="d-inline-block">
                                                ...
                                                <p class="mb-6">Software Engineer</p>
                                            </li><!-- /li -->
                                        </ul>
                                    </div><!-- /col -->
                                    <div class="col-xl-6  col-lg-12  col-md-6  col-sm-12 col-12">
                                        <ul class="about-info">
                                            ...
                                            <li class="d-inline-block">
                                                <p class="mb-6">+8801765849345</p>
                                                <p class="mb-6">darahat42@gmail.com</p>
