            ...
            <div class="row price-wrapper justify-content-center mt-80">
                ...
                >
                    ...
                    >
                        ...
                        <p class="mt-20 mb-10 f-500 main-color">
                            <span class="theme-color rate pr-12">$25</span>/ Per
                            Hour
                        </p>
                        <ul class="price-list">
                            <li class="d-flex align-items-center">
                                <span
                                    class="theme-color d-inline-block text-center"
                        ...
                        <a
                            href="#contact"
                            class="btn position-relative over-hidden text-uppercase mt-25"
                            >Start now</a
                        >
                    </div>
                    <!-- / -->
                ...
                >
                    ...
                    >
                        ...
                        <p class="mt-20 mb-10 f-500 main-color">
                            <span class="theme-color rate pr-12">$15</span>/ Per
                            Hour
                        </p>
                        <ul class="price-list">
                            <li class="d-flex align-items-center">
                ...
                >
                    ...
                    >
                        ...
                        <p class="mt-20 mb-10 f-500 main-color">
                            <span class="theme-color rate pr-12">$10</span>/ Per
                            Hour
                        </p>
                        <ul class="price-list">
                            <li class="d-flex align-items-center">
